$(document).ready(function() {
    ...
    /*自定义题型鼠标点击事件*/
    $(".menuItemBox").on("click", ".customType", function(md) {
        md.preventDefault();
        ...
        $("#emptyBox").remove();
        $("#target").append(customSubjectDiv[parseInt($(this).attr("name"))]);
    ...
    /*题型鼠标落下事件*/
    $(".menuItemBox").on("mousedown", ".customType", function(md) {
        md.preventDefault();
        var tops = [];
        var mouseX = md.pageX;
        var mouseY = md.pageY;
    ...
    /*题型鼠标点击事件*/
    $(".menuItemBox").on("click", ".subType", function(md) {
        md.preventDefault();
